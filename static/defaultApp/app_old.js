(function () {
    ...
    app.config(['$routeProvider',  function ($routeProvider) {
        ...
        $routeProvider
	        ...
	        .when('/salecontrole', {
	        	controller: 'SalecontroleController',
	        	templateUrl: viewBase + 'salecontrole/salecontrole.html',
	        	controllerAs: 'vm'
	        })
	        ...
	        .when('/salecontrole/:cityid', {
	        	controller: 'SalecontroledetailController',
	        	templateUrl: viewBase + 'salecontrole/salecontrole2.html',
	        	controllerAs: 'vm'
	        })
	        .when('/assignments', {
	        ...
	        .when('/waitshop', {
	        	controller: 'TeamshopController',
	        	templateUrl: viewBase + 'salecontrole/waitshops.html',
	        	controllerAs: 'vm'
	        })
