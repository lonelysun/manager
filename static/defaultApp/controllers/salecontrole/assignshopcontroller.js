(function () {
    ...
    var AssignshopController = function ($scope, $location, $routeParams,
                                           $timeout, $route,config, dataService,toaster,displayModel) {
    ...
    AssignshopController.$inject = injectParams;
    angular.module('managerApp').controller('AssignshopController', AssignshopController);
