(function () {
    ...
    var AllchangeController = function ($scope, $location, $routeParams,
                                           $timeout,$route ,config, dataService,toaster,displayModel) {
        ...
        vm.assign = function(){
            ...
            dataService.allchangesaler(salerid,vm.salerid)
            .then(function (data) {
    ...
    AllchangeController.$inject = injectParams;
    angular.module('managerApp').controller('AllchangeController', AllchangeController);
